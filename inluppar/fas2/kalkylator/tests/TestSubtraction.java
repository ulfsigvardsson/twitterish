...
public class TestSubtraction {
    ...
    static int count;
    static String name = "Subtraction";
    ...
    public void testSubtractFromNegative() {
        Parser parser1 = new Parser("(-1)-1");
        Parser parser2 = new Parser("(-1)-(-1)"); 
        
        try {
            SymbolicExpression e1 = parser1.start().eval(this.variables);
            SymbolicExpression e2 = parser2.start().eval(this.variables);
            SymbolicExpression r1 = new Constant(-2);
            SymbolicExpression r2 = new Constant(0);
